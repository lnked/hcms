    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'GraphQL (opt-in, default off): enable under Settings → System → GraphQL, then use /api/graphql (GraphiQL). Same apiEnabled / public.* / grants as REST.',
        ],
        links: [
          { label: 'Open Swagger', href: '/api/docs', external: true },
          { label: 'OpenAPI JSON', href: '/api/openapi.json', external: true },
          { label: 'Open GraphQL', href: '/api/graphql', external: true },
          { label: 'System (enable GraphQL)', href: '/settings/system' },
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'GraphQL (opt-in, по умолчанию выкл): Settings → System → GraphQL, затем /api/graphql (GraphiQL). Тот же apiEnabled / public.* / grants, что REST.',
        ],
        links: [
          { label: 'Открыть Swagger', href: '/api/docs', external: true },
          { label: 'OpenAPI JSON', href: '/api/openapi.json', external: true },
          { label: 'Открыть GraphQL', href: '/api/graphql', external: true },
          { label: 'System (включить GraphQL)', href: '/settings/system' },
          { label: 'Feature flags', href: '/docs/feature-flags' },
          { label: 'Key values', href: '/docs/key-values' },
