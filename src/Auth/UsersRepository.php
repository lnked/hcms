...
final class UsersRepository
{
    ...
    /**
     * @param array{name: string, email: string, password_hash: string, status: string} $data
    ...
    public function update(int $id, array $data): array
    {
        ...
        $this->db->execute(
            'UPDATE cms_users
             SET name = :name, email = :email, password_hash = :password_hash, status = :status, updated_at = :updated_at
             WHERE id = :id',
            [
                'id' => $id,
