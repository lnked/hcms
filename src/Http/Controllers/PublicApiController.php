...
final class PublicApiController
{
    ...
    public function __construct(
        ...
        ?PublicApiAuthorizer $authorizer = null,
    ) {
        $this->authorizer = $authorizer ?? new PublicApiAuthorizer($resources, $grants, $apis);
    }
